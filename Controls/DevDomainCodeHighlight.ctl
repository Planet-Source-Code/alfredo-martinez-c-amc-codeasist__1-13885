...
Private Sub SetAMCPLT()
    ...
    AddWord "%FLD_NAME%", enumKeyword
    AddWord "%FLD_TYPE%", enumKeyword
    AddWord "%DATE%", enumKeyword
    AddWord "%TIME%", enumKeyword
    AddWord "%USER_NAME%", enumKeyword
    AddWord "%REMOVE_LAST_COMMA%", enumKeyword
    AddWord "%REMOVE_LAST_AND%", enumKeyword
    AddWord "%PK_ON%", enumKeyword
    AddWord "%PK_OFF%", enumKeyword
    AddWord "%TABLE_NAME%", enumKeyword
    AddWord "%FOR_EACH_FLD%", enumKeyword
    AddWord "%FOR_EACH_PK_FLD%", enumKeyword
    AddWord "%VB_FLD_TYPE%", enumKeyword
    AddWord "%VB_FLD_TYPE_PREFIX%", enumKeyword
